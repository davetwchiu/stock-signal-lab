...
def ml_score(outperform_probability: pd.Series, drawdown_risk_probability: pd.Series) -> pd.Series:
    """Convert opportunity probability into a 0-100 advisory score.

    Drawdown risk is returned separately and handled downstream by allocation and sizing logic.
    """

    score = 100.0 * outperform_probability.clip(lower=0.0, upper=1.0)
